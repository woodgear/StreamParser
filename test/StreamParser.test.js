...
describe.only("StreamParser iterator", () => {
    it("should parser two  quatrains from  stream", async () => {
        ...
        await new Promise(async(resolve, reject) => {
            ...
            const streamParser = new StreamParser(Quatrains);
            
            //this should be async
            for (let quatrains of streamParser){
                console.log("in for ",quatrains)
                let res=await quatrains;
                console.log("test iterator",res)
            }
            console.log("here");
...
describe("StreamParser callback", () => {
